...
architecture rtl of execute_query_ram is 
...
architecture arch of execute_query is
    component execute_query_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    execute_query_ram_U :  component execute_query_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
